 ...
 */
export async function createStreamableSessionWithId(sessionId, authenticated = false, keyId = null, groupKeyIds = null, permissions = null, defaultWorkspace = null) {
 ...
 * @param {string|null} keyId  DB API 키 ID (마스터 키 세션은 null)
 */
export async function createStreamableSession(authenticated = false, keyId = null, groupKeyIds = null, permissions = null, defaultWorkspace = null) {
  const sessionId           = crypto.randomUUID();
  return createStreamableSessionWithId(sessionId, authenticated, keyId, groupKeyIds, permissions, defaultWorkspace);
}
