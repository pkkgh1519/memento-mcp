...
| timeRange | object | `{ start: string, end: string }` ISO 8601 범위 필터. start~end 구간에 생성된 파편만 반환. asOf와 병용 가능 |
...
| structured | boolean | true 시 Core/Working Memory를 구조화된 JSON 객체로 반환. 기본 false (텍스트 주입) |
